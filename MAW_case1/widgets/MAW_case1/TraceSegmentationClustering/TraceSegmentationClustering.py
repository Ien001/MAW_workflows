...
class OWTraceSegmentationClustering(OWBwBWidget):
    name = "TraceSegmentationClustering"
    description = "Minimum Python3 container with pip"
    priority = 10
    icon = getIconName(__file__,"footprint.svg")
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"TraceSegmentationClustering")) as f:
